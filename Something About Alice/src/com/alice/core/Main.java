...
public class Main {
	...
	public static void main(String[] args) {
		...
		mainScheduler.stepSchedule(mainPeopleManager.returnClassList());
		RelationshipEffectManager relationEffectManager = new RelationshipEffectManager();
		relationEffectManager.createTemplateJson(30);
		}
	}
}